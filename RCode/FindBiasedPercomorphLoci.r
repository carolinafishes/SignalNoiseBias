...
data_folder <- "~/Documents/SignalNoiseBiasPaper/Archiving/Percomorpha/MathematicaResults"  # Replace with your actual folder path
...
ratios_sorted %>% 
mutate(SignalvsNoise = signal-noise)
